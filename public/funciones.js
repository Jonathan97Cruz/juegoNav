window.onload = function () {
	...
	if (canvas && canvas.getContext) {
		...
		if (ctx) {
			x = canvas.width;
	alert("Dispara con la barra espaciadora\nMuevete con las teclas (🡸 y 🡺)\nRefresca para intentar de nuevo, en caso de perder\no querer jugar de nuevo✌🤘🙉\nPresiona enter o aceptar para iniciar");
			mensaje("VAMOS 👨🏻‍💻");
			imgNave = new Image();
			imgOvni = new Image();
			imgOvni.src = "imagenes/metal.png";
			imgNave.src = "imagenes/naveee.png";
